...
//  Demo
//
//  Created by zhaojialong on 2019/12/23.
...
void TestOneAllocate()
{
    ...
    __MallocAllocTemplate<0>::Allocate(0xFFFFFFFF00000000);
}
...
private:
    ...
    typedef __MallocAllocTemplate <inst> MALLOC;
public:
